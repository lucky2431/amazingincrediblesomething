(function () {
    ...
    var CACHE_SIZE = 100;
    var CACHE_TIME = 1000 * 60 * 60; // 1 година
    var cache = {};

    // Налаштування видимості груп років
    ...
    // Налаштування видимості категорій
    var CATEGORY_VISIBILITY = {
        k4_new: {
            title: 'У високій якості нові',
    ...
    // Динамічно додаємо категорії для років
    ...
    function NumparserApiService() {
        ...
        self.category = function (params, onSuccess, onError) {
            ...
            // Основні категорії з новим порядком
            ...
            // Додаємо категорії за роками у зворотному порядку (від нових до старих)
            for (var year = currentYear; year >= 1980; year--) {
                if (isYearVisible(year)) {
                    (function(y) {
                        partsData.push(function(callback) {
                            makeRequest(CATEGORIES['movies_id_' + y], 'Фільми ' + y + ' року', callback);
                        });
                    })(year);
                }
            }
    ...
    function startPlugin() {
        ...
        // Налаштування для зміни назви джерела
        Lampa.SettingsApi.addParam({
            ...
            field: {
                name: 'Назва джерела',
                description: 'Зміна назви джерела в меню'
            },
